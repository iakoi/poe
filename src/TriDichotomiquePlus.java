...
public class TriDichotomiquePlus {

    public static void main(String[] args) {
        int valeurRecherchee = 91;
        int indiceValeurRecherchee = -1;
        int[] tab = {2, 6, 18, 24, 90, 100};
        int indiceDebut = 0;
        ...
        while (!end) {
            int indiceMid = getIndiceMid(indiceDebut, indiceFin);
    ...
    private static int getIndiceMid(int indiceDebut, int indiceFin) {
        int indiceMid;
